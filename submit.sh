...
# NURD d TODO write cond_x_top_prior, code for prior to use x_top
python \
  vqvae_prior.py --vqvae_dir joint_d \
                 --restore_dir  joint_d_prior_bottom joint_d_prior\
                 --generate \
...
python \
  vqvae_prior.py --vqvae_dir joint_dz \
                 --restore_dir  joint_dz_prior_bottom joint_dz_prior\
                 --generate \
                 --n_samples 12500 \
                 --cuda 0 \
                 --n_cond_classes 2 \
