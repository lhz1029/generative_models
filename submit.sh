...
# padchest
python vqvae.py --train --n_embeddings 64 --n_epochs 60 --ema --cuda 0 --dataset joint_chest --output_dir joint_dz_quick_padchest --cond_x top && \
python vqvae_prior.py --vqvae_dir joint_dz_quick_padchest --train --n_epochs 50 --batch_size 256 --lr 0.00005 --which_prior top  --n_cond_classes 2 --n_channels 128 --n_res_layers 5 --n_out_stack_layers 10 --n_cond_stack_layers 0 --drop_rate 0.1 --cuda 0 --output_dir joint_dz_quick_padchest_prior --cond_x top && \
python vqvae_prior.py --vqvae_dir joint_dz_quick_padchest --train --n_epochs 50 --batch_size 256 --lr 0.00005 --which_prior bottom --n_cond_classes 2 --n_channels 128 --n_res_layers 20 --n_out_stack_layers 0 --n_cond_stack_layers 10 --drop_rate 0.1 --output_dir joint_dz_quick_padchest_prior_bottom  --cuda 0 --cond_x top && \
python  vqvae_prior.py --vqvae_dir joint_dz_quick_padchest --restore_dir joint_dz_quick_prior_bottom joint_dz_quick_prior --generate --n_samples 12800 --cuda 0  --n_cond_classes 2  --cond_x top --batch_size 128 --hosp true --data_output_dir generated/nurd_padchest_top
...
python  vqvae_prior.py --vqvae_dir joint_dz_quick_mimic_outer --restore_dir joint_dz_quick_mimic_outer_prior_bottom joint_dz_quick_mimic_outer_prior --generate --n_samples 12800 --cuda 0  --n_cond_classes 2  --cond_x top --batch_size 128 --hosp true --data_output_dir generated/nurd_mimic_outer

# padchest outer
python vqvae.py --train --n_embeddings 64 --n_epochs 60 --ema --cuda 0 --dataset joint_chest --output_dir joint_dz_quick_padchest_outer --cond_x outer && \
python vqvae_prior.py --vqvae_dir joint_dz_quick_padchest_outer --train --n_epochs 50 --batch_size 256 --lr 0.00005 --which_prior top  --n_cond_classes 2 --n_channels 128 --n_res_layers 5 --n_out_stack_layers 10 --n_cond_stack_layers 0 --drop_rate 0.1 --cuda 0 --output_dir joint_dz_quick_padchest_outer_prior --cond_x outer && \
python vqvae_prior.py --vqvae_dir joint_dz_quick_padchest_outer --train --n_epochs 50 --batch_size 256 --lr 0.00005 --which_prior bottom --n_cond_classes 2 --n_channels 128 --n_res_layers 20 --n_out_stack_layers 0 --n_cond_stack_layers 10 --drop_rate 0.1 --output_dir joint_dz_quick_padchest_outer_prior_bottom  --cuda 0 --cond_x outer && \
python  vqvae_prior.py --vqvae_dir joint_dz_quick_padchest_outer --restore_dir joint_dz_quick_padchest_outer_prior_bottom joint_dz_quick_padchest_outer_prior --generate --n_samples 12800 --cuda 0  --n_cond_classes 2  --cond_x top --batch_size 128 --hosp true --data_output_dir generated/nurd_padchest_outer
