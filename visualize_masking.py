...
if __name__ == "__main__":
    ...
    ax2.imshow(holemask(image, h=int(2800*.75), w=int(2800*.75), SIDE=2800, is_torch=False), cmap="gray")
    ax3.imshow(onlycenter(image, h=int(2800*.75), w=int(2800*.75), SIDE=2800, is_torch=False), cmap="gray")
