...
def Aug(image):
    img_aug = tfs.Compose([
        tfs.RandomAffine(degrees=(-30, 30), translate=(0.05, 0.05),
                         scale=(0.95, 1.05), fillcolor=0),
        tfs.RandomResizedCrop((512, 512), scale=(0.5, 1.0), ratio=(1.0, 1.0), interpolation=2)
    ])
    image = img_aug(image)
